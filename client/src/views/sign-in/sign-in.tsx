...
export function SignIn(props: { path: string, auth: Auth, user: User | undefined }) {
          ...
          <div class="providers">
            <button class="provider_button" onClick={() => signInGoogle()}>
              <div class="provider_button_panel">
                ...
                <span class="provider_label">Sign in with Google</span>
              </div>
            </button>
            ...
            <button class="provider_button" onClick={() => signInMicrosoft()}>
              <div class="provider_button_panel">
                ...
                <span class="provider_label" style="padding-left: 8px">Sign in with Microsoft</span>
              </div>
            </button>

            <button class="provider_button" onClick={() => route("/sign-in-password")}>
              <div class="provider_button_panel">
                ...
                <span class="provider_label" style="padding-left: 6px">Sign in with Email</span>
              </div>
            </button>
          </div>
        </div>
